String getWeatherIcon({
  ...
  if (weatherCode == 801) {
    weatherCondition = 'assets/icons/02d.png'; //few cloud
  } else if (weatherCode == 802) {
    weatherCondition = 'assets/icons/03d.png'; // scattered clouds
  } else if (weatherCode == 803) {
    weatherCondition = 'assets/icons/04d.png'; // broken clouds
  } else if (weatherCode == 804) {
    weatherCondition = 'assets/icons/04d.png'; //overcast clouds
  } else if (weatherCode == 800) {
    weatherCondition = 'assets/icons/01d.png'; //clear
  } else if (weatherCode > 700 && weatherCode < 782) {
    weatherCondition = 'assets/icons/50d.png'; //vent
  } else if (weatherCode >= 600 && weatherCode < 623) {
    weatherCondition = 'assets/icons/13d.png'; //snow
  } else if (weatherCode >= 500 && weatherCode < 532) {
    weatherCondition = 'assets/icons/10d.png'; //rain
  } else if (weatherCode >= 300 && weatherCode < 322) {
    weatherCondition = 'assets/icons/09d.png'; //drizzle
  } else if (weatherCode >= 200 && weatherCode < 233) {
    weatherCondition = 'assets/icons/11d.png'; //thunderstorm
  }
